...
public class AppointmentRequestDAO {
    ...
    public List<Model_AppointmentRequest> getAllRequests() {
        ...
        String sql = "SELECT ar.request_id, ar.patient_custom_id, u.username AS patient_name, u.email AS patient_email, "
        ...
        try (Connection conn = DBConnection.getInstance().getConnection(); 
            ...
            while (rs.next()) {
                list.add(new Model_AppointmentRequest(
                        rs.getInt("request_id"),
                        rs.getString("patient_custom_id"),
                        rs.getString("patient_name"),
                        rs.getString("patient_email"),
                        rs.getDate("preferred_date"),
                        rs.getString("preferred_time_slot"),
                        "Any Dentist",
                        rs.getString("notes"),
                        rs.getString("status")
                ));
